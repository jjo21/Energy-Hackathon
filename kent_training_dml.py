...
plt.title(f'DM-L Trend Feature Importances RMSE: {rmse:.2f}')
plt.savefig('kent_result_plots/dml_trend_feature_importances.png')
...
plt.title('DM-L Price Feature Importances')
plt.savefig('kent_result_plots/dml_price_feature_importances.png')
...
plt.savefig('kent_result_plots/dml_price_predictions.png')